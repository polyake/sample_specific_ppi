...
def run_metric_calculator(file):
    ...
    metrics_df.to_csv("metrics_data/network_metrics_"+file[:-4]+".csv")
    degree_centrality.to_csv("metrics_data/degree_centralities_"+file[:-4]+".csv")
    node_degrees.to_csv("metrics_data/degrees_"+file[:-4]+".csv")
    clust_df.to_csv("metrics_data/clustering_coefs_"+file[:-4]+".csv")
    node_bc_df.to_csv("metrics_data/node_bcs_"+file[:-4]+".csv")
    print("done")
