...
def run_metric_calculator(file):
    sample = file[8:-12]
    network_df = pd.read_csv("network_data/"+file)
    ...
    metrics_df.to_csv("metrics_data/protein_network_metrics_"+file[:-4]+".csv")
    degree_centrality.to_csv("metrics_data/protein_degree_centralities_"+file[:-4]+".csv")
    node_degrees.to_csv("metrics_data/protein_degrees_"+file[:-4]+".csv")
    clust_df.to_csv("metrics_data/protein_clustering_coefs_"+file[:-4]+".csv")
    node_bc_df.to_csv("metrics_data/protein_node_bcs_"+file[:-4]+".csv")
    print("done")
...
files = ["protein_g-1 _network.csv", "protein_g-3_network.csv", "protein_g-4_network.csv", "protein_g-5_network.csv",
        "protein_g-6_network.csv", "protein_g-7_network.csv", "protein_g-8_network.csv", "protein_g-9_network.csv"]
          
with Pool(processes=5) as pool:
    pool.map(run_metric_calculator, files)